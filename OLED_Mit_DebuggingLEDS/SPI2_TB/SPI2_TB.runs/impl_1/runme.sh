...
HD_PWD='C:/Users/fij32622/Desktop/SPI2_TB/SPI2_TB.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log LCD_INIT.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source LCD_INIT.tcl -notrace
