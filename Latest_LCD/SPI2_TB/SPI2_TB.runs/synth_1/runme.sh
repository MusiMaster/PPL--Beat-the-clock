...
HD_PWD='C:/Users/fij32622/Desktop/SPI2_TB/SPI2_TB.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log LCD_INIT.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source LCD_INIT.tcl
