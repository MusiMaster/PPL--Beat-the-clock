...
HD_PWD='G:/SPI2_TB/SPI2_TB.runs/design_1_LCD_INIT_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_LCD_INIT_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_LCD_INIT_0_0.tcl
