...
HD_PWD='G:/SPI2_TB/SPI2_TB.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Send8BitSPI2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Send8BitSPI2.tcl -notrace
