...
ARCHITECTURE behavior OF Send8BitSPI2 IS
  ...
  signal spi_ss_lock        : STD_LOGIC_VECTOR(0 DOWNTO 0);
  signal reset_spi_sig      : STD_LOGIC := '1';
  

  signal ss_temp            : STD_LOGIC_VECTOR(0 DOWNTO 0);
...
BEGIN
  ...
  ss_temp <= spi_0_ss_n when spi_select = "00" else spi_1_ss_n when spi_select = "01" else spi_2_ss_n;
  ss_n <= ss_temp OR spi_ss_lock;
