...
HD_PWD='/home/fij32622/Documents/PPL--Beat-the-clock/SPI2_TB/SPI2_TB.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Send8BitSPI2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Send8BitSPI2.tcl
